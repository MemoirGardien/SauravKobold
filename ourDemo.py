...
#Reliable Systems Voter System Front-End
#Taken from Dr. Steven Crain's demo.py
#Reliable Systems Group projects
#Team Members: Ryan Norton, Saurav Gautam, Quan Le, Barbara Lyn Crotty, Brianna Estrada
...
""" Example code, showing how to build a voting system that meets the
   ...
   Ver 0.92, 11/11/2016: Added doc strings. Added roll-back logic (untested).
"""
